...
// Fetch guide content for AMD category
$stmt = $conn->prepare("SELECT article_url, video_url, quiz_url FROM lessons WHERE category_id = (SELECT id FROM learn_categories WHERE name = 'AMD Build')");
$stmt->execute();
...
<head>
   ...
   <title>Learn to Build Your AMD PC</title>
...
<div class="heading">
   <h3>Learn to Build Your AMD PC</h3>
</div>
