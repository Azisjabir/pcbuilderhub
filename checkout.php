...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      <a href="cart.php" class="btn">View</a>
   </div>
   ...
   <div class="user-info">
      ...
      <select name="method" class="box" required>
         ...
         <option value="qr_pay">QRpay</option>
      </select>

      <!-- New bank selection dropdown (initially hidden) -->
      <select name="bank" id="bank_selection" class="box" style="display: none;">
...
document.querySelector('select[name="method"]').addEventListener('change', function() {
    ...
    if (this.value === 'online_banking') {
        ...
        bankSelection.required = true;
    } else if (this.value === 'qr_pay') {
        window.location.href = 'qr_payment.php';
    } else {
        bankSelection.style.display = 'none';
        bankSelection.required = false;
    }
});

// Add new event listener for bank selection
document.getElementById('bank_selection').addEventListener('change', function() {
    if (this.value) {
        window.location.href = `bank_payment.php?bank=${this.value}`;
    }
});
</script>
